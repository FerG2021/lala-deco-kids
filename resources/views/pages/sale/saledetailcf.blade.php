...
@section('title', 'Detalle nueva venta CF')
            ...
            <div class="panel shadow">
               ...
               <div class="inside">
                ...
                <div class="product-sale">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <select name="barcodeproductsearch" id="barcodeproductsearch" class="form-select" onchange="selectProductSaleBarCode(this);" class="gui-input" autofocus>
                                    <option selected disabled>Ingrese codigo de barra</option>                                    
                    ...
                    <form action="/sale/{{$id}}/addnewsaleproductcf" method="post">
                    @csrf
                ...
                <div class="table mtop16 descriptionname">
                                ...
                                <tbody>
                                    @foreach ($saleproducts as $saleproduct)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/sale/{{$saleproduct->id}}/deletesaleproductcf" class="btn btn-danger btn-list-delete" data-toggle="tooltip" data-placement="top" title="Quitar">
                        ...
                        @csrf
                            ...
                            <div class="btn">
                                <button class="btn btn-success success">Guardar venta</button>
                        </form>
                                <a href="/sale/{{$id}}/cancelnewsalecf" class="btn btn-danger delete">Cancelar venta</a>    
                            </div>
